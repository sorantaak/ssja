class Strings {
  ...
  static agentInfo = "مشخصات مشاور املاک";
  static userInfo = "مشخصات کاربر";
  static adminInfo = "مشخصات نماینده‌ی سایت";
  static ownerInfo = "مشخصات مدیر سایت";
  static withoutName = "بدون نام";
  static normalUser = "کاربر عادی";
  static adminUser = "کاربر نماینده‌ی سایت";
  static ownerUser = "کاربر مدیر سایت";
  static agentUser = "کاربر مشاور املاک";
  static searchUsers = "جستجوی کاربران";
  static searchAdmins = "جستجوی نمایندگان سایت";
  static searchOwners = "جستجوی مدیران سایت";
  static searchAgents = "جستجوی مشاوران املاک";
